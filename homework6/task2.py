"""
Из файла "Input.txt" берутся данные о количестве атомов
углеорода, водорода и кислорода.
В файл "Output.txt" выводится максимальное возможное
число молекул спирта.
"""
try:
