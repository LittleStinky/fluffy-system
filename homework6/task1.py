...
print("Преобразование списка строк в список байт-кодов:", 
      list_encode(list_str = list(input("\nВведите список строк, разделенных запятыми:").split(','))), '\n')
...
print("Проверка применения обратных функций друг к другу:", 
      list_decode(list_encode(list_str = list(input("Введите список строк, разделенных запятыми:").split(',')))))
